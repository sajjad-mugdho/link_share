  ...
  return (
    <div className="linksContainer">
      ...
      <div className="editPanel">
        ...
        <button className="addLinkButton" onClick={createNewLink}>
          <p className="addLinkButtonText">+ Add new link</p>
        </button>
        <div className="editPanelBody">
          {loading === true ? (
            <div className="addLinkBody">
              <Spinner color="black" />
            </div>
            ...
            <div className="addLinkBody">
              <div className="addLinkBodyContent">
                <svg
                  className="addLinkBodyContentImage"
                ...
                <div className="addLinkBodyContentTextContainer">
                  <h1 className="addLinkBodyContentTextContainerHeader">
                    Let&apos;s get you started
                  </h1>
                  <p className="addLinkBodyContentTextContainerP">
                    Use the “Add new link” button to{" "}
                    <br className="lineBreak" />
                    get started. Once you have more <br className="lineBreak" />
            ...
            createLinkObjects?.map((content, index) => {
              return (
                <CreateLink
                  ...
                  id={index}
                  index={index}
                  deleteLink={removeCreatelinkObject}
                  platformOption={content.platformOption}
                  linkText={content.linkText}
                  createLinkObjects={createLinkObjects}
                  setAppPlatform={setPlatform}
                  setAppLink={setLink}
                />
              );
            })
        ...
        <div className="savePanel">
          ...
          <button
            onClick={handleSave}
            disabled={createLinkObjects?.length === 0}
            className={`saveButton ${
              createLinkObjects?.length === 0 ? "disabled" : ""
            } ${saving ? "disabled" : ""}`}
          >
            {saving ? "Saving" : "Save"}
          </button>
